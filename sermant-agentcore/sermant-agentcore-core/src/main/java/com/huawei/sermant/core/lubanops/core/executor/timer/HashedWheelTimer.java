...
package com.huawei.sermant.core.lubanops.core.executor.timer;
...
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long tickDuration, TimeUnit unit, int ticksPerWheel,
        ...
        if (INSTANCE_COUNTER.incrementAndGet() > INSTANCE_COUNT_LIMIT && WARNED_TOO_MANY_INSTANCES.compareAndSet(false,
            true)) {
    ...
    private static void reportTooManyInstances() {
        ...
        LOGGER.log(Level.SEVERE, "You are creating too many " + resourceType + " instances. " + resourceType
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public void expire() {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "An exception was thrown by " + TimerTask.class.getSimpleName() + '.', t);
            }
        }
        ...
        private void processCancelledTasks() {
            for (; ; ) {
                ...
                try {
                    ...
                    LOGGER.log(Level.SEVERE, "An exception was thrown while process a cancellation task", t);
                }
            }
        }
